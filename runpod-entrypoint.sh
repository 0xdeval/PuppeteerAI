...
LLM_MODEL_PRIMARY=${LLM_MODEL_PRIMARY:-aiden_lu/minicpm-v2.6:Q4_K_M}
LLM_MODEL_FALLBACK=${LLM_MODEL_FALLBACK:-aiden_lu/minicpm-v2.6:Q4_K_M}
PORT=${PORT:-3001}
...
MODEL="${LLM_MODEL_PRIMARY:-aiden_lu/minicpm-v2.6:Q4_K_M}"
